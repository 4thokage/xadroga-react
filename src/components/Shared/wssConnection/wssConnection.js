...
import {WSS_CHAT} from "../XadrogaConstants";
...
const handleBroadcastEvents = (data) => {
  switch (data.event) {
    case broadcastEventTypes.ACTIVE_USERS:
      ...
      store.dispatch(homeActions.setActiveUsers(activeUsers));
      break;
    case broadcastEventTypes.GROUP_CALL_ROOMS:
      ...
      store.dispatch(homeActions.setGroupCalls(groupCallRooms));
      break;
    default:
      break;
  }
