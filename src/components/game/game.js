    ...
    return (
      <div style = {{ background: '#2b313c', height: '100vh' }}>
        <Chat
          ...
          roomId={this.props.socket.id}
          socket={this.props.socket}
        />
        <VideoChat receiverID={this.props.socket.id} />
        <Col span = { 6 } />
        ...
        <Modal show = { !!(this.state.gameOver || this.state.gameAborted) } onHide = {_ => this.handleClose() } >
